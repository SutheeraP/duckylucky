            ...
            <div className="container px-6 relative z-10 my-auto mx-auto">
              <div className="max-w-[1000px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                  <button className='ring-2 ring-black rounded-lg bg-white py-2 md:py-4 text-center' onClick={()=>{router.push('/waitingroom?prop1=value1')}}>สุ่มห้อง</button>
                  <button className="ring-2 ring-black rounded-lg bg-white py-2 md:py-4" onClick={()=>{router.push('/waitingroom?prop1=value2')}}>สร้างห้อง</button>
                </div>
              </div>
            </div>
          </div>
